...
class VRButton{
	...
	showEnterVR( button ) {
        ...
        button.onmouseenter = function(){
            ...
            //button.innerHTML = (currentSession===null) ? 'Enter VR' : 'Leave VR';
            //button.textContent = (currentSession===null) ? 'Enter VR' : 'Leave VR';
            //if (currentSession==null) button.textContent = 'Enter VR';
